...
export default function AdminDashboard() {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const [menuResponse, salesResponse, ordersResponse] = await Promise.all([fetch("/api/menu-items/count"), fetch("/api/orders/today-sales"), fetch("/api/orders/stats")]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <Button variant="primary" onClick={() => router.push("/admin/catalog")} className="w-full">
                Manage Menu
              </Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <Button variant="primary" onClick={() => router.push("/admin/sales-report")} className="w-full">
                View Reports
              </Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <Button variant="primary" onClick={() => router.push("/admin/settings")} className="w-full">
                Open Settings
              </Button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200">
          ...
          <div className="p-6">
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">Activity will appear here when you start managing your restaurant</p>
            </div>
          </div>
        </div>
      </div>
