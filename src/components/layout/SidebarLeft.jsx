...
const SidebarLeft = () => {
  ...
  const navigationItems = [
    ...(isAdmin
      ...
      : []),
    {
      name: isAdmin ? "List Menu/Catalog" : "List Menu",
      href: isAdmin ? "/admin/catalog" : "/cashier",
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      name: "Sales Report",
      href: isAdmin ? "/admin/sales-report" : "/cashier/sales-report",
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
    ...
    {
      name: "Settings",
      href: isAdmin ? "/admin/settings" : "/cashier/settings",
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
  ...
  return (
    <div className={clsx("bg-white shadow-lg border-r border-gray-200 transition-all duration-300 flex flex-col", isCollapsed ? "w-16" : "w-64")}>
      {/* Header */}
